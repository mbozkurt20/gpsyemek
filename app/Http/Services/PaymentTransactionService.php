...
class PaymentTransactionService
{
    ...
    public function rejected()
    {
        ...
        return [
            'status'  => false,
            'message' => 'Siparişiniz bulunamadı veya ödemeniz yapılmadı',
        ];
    }
    ...
    private function generateReceiveTransaction($order)
    {
        ...
        if (!$restaurantowner_balance_id) {
            return [
                'status'  => false,
                'message' => 'Restoran sahibi bakiyesi eksik',
            ];
        }
        ...
        return [
            'status'  => true,
            'message' => 'Sipariş ödemesi başarıyla gerçekleştirildi',
        ];
    }
    ...
    private function generateRejectedTransaction($order)
    {
        ...
        return [
            'status'  => true,
            'message' => 'Sipariş ödemeniz başarıyla iptal edildi',
        ];
    }
