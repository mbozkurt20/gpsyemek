...
class SettingController extends BackendController
{
    ...
    public function siteSettingUpdate(Request $request)
    {
        ...
        if (env('DEMO_MODE')) {
            return back()->withError('Uygulama ayarı demo için devre dışı bırakıldı');
        }
        ...
        return redirect(route('admin.setting.index'))->withSuccess('Site ayarı başarıyla güncellendi');
    }
    ...
    public function smsSettingUpdate(Request $request)
    {
        ...
        Setting::set($settingArray);
        Setting::save();
        return redirect(route('admin.setting.sms'))->withSuccess('SMS ayarı başarıyla güncellendi.');
    }
    ...
    public function appSettingUpdate(Request $request)
    {
        ...
        Setting::set($settingArray);
        Setting::save();
        return redirect(route('admin.setting.app'))->withSuccess('Uygulama ayarı başarıyla güncellendi.');
    }
    ...
    public function supportSettingUpdate(Request $request)
    {
        ...
        Setting::set($settingArray);
        Setting::save();
        return redirect(route('admin.setting.support'))->withSuccess('Destek ayarı başarıyla güncellendi.');
    }
    ...
    public function paymentSettingUpdate(Request $request)
    {
        ...
        return redirect(route('admin.setting.payment'))->withSuccess('Ödeme ayarı başarıyla güncellendi.');
    }
    ...
    {
        $niceNames    = [];
        $settingArray = $this->validate($request, $this->iyzicoValidateArray(), [], $niceNames);
