...
class AccountController extends FrontendController
{
    ...
    {
        parent::__construct();
        $this->data['site_title'] = 'Siparişlerim';
    }

    public function index()
    {
        $this->data['site_title'] = 'Profil';
    ...
    {
        $this->data['site_title'] = 'Şifre Değiştir';
    ...
    public function getReservation()
    {
        ...
        $this->data['site_title'] = 'Rezervasyonum';
    ...
    {
        $this->data['site_title'] = 'İşlemlerim';
