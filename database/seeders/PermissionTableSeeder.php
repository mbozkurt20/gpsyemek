...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $i++;
        $permissionArray[$i]['name']       = 'expense';
        $permissionArray[$i]['guard_name'] = 'web';

        $i++;
        $permissionArray[$i]['name']       = 'expense_create';
        $permissionArray[$i]['guard_name'] = 'web';

        $i++;
        $permissionArray[$i]['name']       = 'expense_edit';
        $permissionArray[$i]['guard_name'] = 'web';

        $i++;
        $permissionArray[$i]['name']       = 'expense_delete';
        $permissionArray[$i]['guard_name'] = 'web';

        $i++;
        $permissionArray[$i]['name']       = 'expense_show';
        $permissionArray[$i]['guard_name'] = 'web';
