...
class BackendMenuTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $parent = [
            'manage_restaurant'   => 3,
            'reservation_orders'  => 11,
            'promo_communication' => 16,
            'account'             => 21,
            'users_addon'         => 27,
            'report'              => 33,
            'setup'               => 42,
        ...
        $menus = [
            ...
            [
                ...
                'parent_id' => $parent['reservation_orders'],
                'priority'  => 89,
                'status'    => 1,
            ],
            [
            ...
            [
                ...
                'parent_id' => $parent['promo_communication'],
                'priority'  => 88,
                'status'    => 1,
            ],
            [
