        ...
        <div class="row">
            <div class="col-12 col-sm-4 col-lg-3">
                <div class="footer-about">
                    <a href="{{ url('/') }}" class="footer-logo"><img
                            src="{{ themeSetting('site_footer_logo') ? themeSetting('site_footer_logo')->footerLogo : asset('frontend/images/gpsyemek.png') }}" alt="logo"></a>
                    <p> {{ __('footer.Follow Us on') }} </p>
                    <nav>
                        @if (setting('facebook'))
            ...
            <div class="col-12 col-lg-3">
                <div class="footer-contact">
                    <h5 class="footer-title"> {{ __('footer.Download Apps') }} </h5>
                    <nav>
