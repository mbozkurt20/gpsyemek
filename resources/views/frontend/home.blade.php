...
@section('main-content')
            ...
            <div class="row align-items-center">
                                    ...
                                    <span id="locationIcon" onclick="getLocation()">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path
                                                ...
                                                stroke="#259A38" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"/>
                                            <path
                                                d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z"
                                                stroke="#259A38" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"/>
                                            <path d="M12 4V2" stroke="#259A38" stroke-width="1.5" stroke-linecap="round"
                                                  stroke-linejoin="round"/>
                                            <path d="M4 12H2" stroke="#259A38" stroke-width="1.5" stroke-linecap="round"
                                                  stroke-linejoin="round"/>
                                            <path d="M12 20V22" stroke="#259A38" stroke-width="1.5"
                                                  stroke-linecap="round"
                                                  stroke-linejoin="round"/>
                                            <path d="M20 12H22" stroke="#259A38" stroke-width="1.5"
                                                  stroke-linecap="round"
                                                  stroke-linejoin="round"/>
                                        </svg>
                                    </span>
                ...
                <div class="col-12 col-md-5 col-lg-6">
                    <div class="banner-image text-center">
                        <img id="heroBanner" src="{{ asset('images/seeder/banner/banner1.png') }}" alt="hero"
                             style="width:100%; max-width:100%;">
                    </div>

                    <!-- Buttons Under Image -->
                    <div class="d-flex justify-content-center gap-3 mt-3">
                        <button style="font-size: 30px" onclick="prevBanner()"
                                class="btn btn-light size-4 bg-white px-4 py-2">‹
                        </button>
                        <button style="font-size: 30px" onclick="nextBanner()" class="btn btn-light px-4 bg-white py-2">
                            ›
                        </button>
                    </div>
                </div>
    ...
    <section class="feature">
        <div class="container">
            <span class="section-subtitle"> {{ __('frontend.How to Order') }} </span>
            <h2 class="section-title"> {{ __('frontend.It’s as easy as this ') }} </h2>
            ...
            <div class="swiper feature-swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        ...
                        <h3> {{ __('frontend.Provide your location') }} </h3>
                        <p> {{ __('frontend.Fill out your address & search ') }} </p>
                    </div>
                    <div class="swiper-slide">
                        <svg width="70" height="70" viewBox="0 0 70 70" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3> {{ __('frontend.Choose your restaurant & food') }} </h3>
                        <p> {{ __('frontend.Browse through many restaurant and cuisine') }}</p>
                    </div>
                    <div class="swiper-slide">
                        <svg width="70" height="70" viewBox="0 0 70 70" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3> {{ __('frontend.Pay & get your food') }} </h3>
                        <p> {{ __('frontend.Pay using various payment methods') }}</p>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <div class="app-content">
                            <h2>{{ __('frontend.Download the app') }} </h2>
                            <p> {{ __('frontend.Click, sit back, and enjoy.') }}</p>
...
@push('js')
    ...
    <script async
            src="https://maps.googleapis.com/maps/api/js?key={{ setting('google_map_api_key') }}&sensor=false&libraries=places&callback=initAutocomplete"></script>
@endpush
