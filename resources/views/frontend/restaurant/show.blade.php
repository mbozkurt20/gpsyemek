                                ...
                                <button type="button" class="rest-info-btn" data-bs-toggle="modal"
                                    ...
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="#259A38" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M8 5.3335V8.66683" stroke="#259A38" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path d="M7.99609 10.6665H8.00208" stroke="#259A38" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </button>
                            </div>
