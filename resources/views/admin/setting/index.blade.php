            ...
            <div class = "db-card">
                ...
                <div class = "h-0 overflow-hidden md:h-auto md:overflow-auto transition-all duration-300">
                    <nav class ="p-3">
                        ...
                        <a href="{{ route('admin.setting.recaptcha') }}" class="db-tab-btn {{ request()->is('admin/setting/recaptcha') ? 'active' : '' }}"> <i class="fa-solid fa-robot"></i> {{ __('setting.recaptcha_setting') }}</a>
