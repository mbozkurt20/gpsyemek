...
<div class="row">
    <div class="col-12">
        ...
        {{ Breadcrumbs::render('profile/view') }}
        </div>
    </div>
        ...
        <div class="db-card">
            ...
            <div class="db-card-body">
                <div class="row py-2">
                    ...
                    <div class="col-12 sm:col-6 !py-1.5">
                        <div class="db-list-item p-0">
                            <span class="db-list-item-title w-full sm:w-1/2">{{ __('levels.order') }}</span>
                            <span class="db-list-item-text w-full sm:w-1/2">{{ $ordercount }}</span>
                        </div>
                    </div>
                    @if(auth()->user()->myrole == App\Enums\UserRole::DELIVERYBOY)
                    <div class="col-12 sm:col-6 !py-1.5">
                        <div class="db-list-item p-0">
                            <span class="db-list-item-title w-full sm:w-1/2">{{ __('levels.limit') }}</span>
                            <span class="db-list-item-text w-full sm:w-1/2">
                    ...
                    <div class="col-12 sm:col-6 !py-1.5">
                        <div class="db-list-item p-0">
                            <span class="db-list-item-title w-full sm:w-1/2">{{ __('levels.deposit') }}</span>
                            <span class="db-list-item-text w-full sm:w-1/2">
                    ...
                    <div class="col-12 sm:col-6 !py-1.5">
                        <div class="db-list-item p-0">
                            <span class="db-list-item-title w-full sm:w-1/2">{{ __('C.O.D. Amount') }}</span>
                            <span class="db-list-item-text w-full sm:w-1/2">
