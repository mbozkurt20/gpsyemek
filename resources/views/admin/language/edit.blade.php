...
<div class="row">
	<div class="col-12">
		<div class="custome-breadcrumb">
			{{ Breadcrumbs::render('settings/language/edit') }}
		</div>
	</div>
</div>
@endsection
				...
				<form action="{{ route('admin.language.update', $language) }}" method="POST">
					...
					<div class="row">
						<div class="form-col-12 sm:form-col-6 md:form-col-4">
							...
							<input type="text" name="name" class="db-field-control @error('name') invalid @enderror" value="{{ old('name', $language->name) }}">
						...
						<div class="form-col-12 sm:form-col-6 md:form-col-4">
							...
							<input type="text" name="code" class="db-field-control @error('code') invalid @enderror" value="{{ old('code', $language->code) }}">
