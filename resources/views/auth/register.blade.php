                    ...
                    <div class="auth-content">
                        <nav class="auth-navs">
                            ...
                            <a class="nav-link active"
                               href="{{ route('register') }}"> {{ __('register.register') }}</a>
                        </nav>
                        <div class="auth-tabs">
                            <form method="POST" class="register" action="{{ route('register') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label for="username"
                                                   class="form-label required">{{ __('register.username') }}</label>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="register_email"
                                                   value="{{ session('verified_type') == 'email' ? session('verified_value') : old('register_email') }}"
                                                   type="email" required
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input required
                                                   value="{{ session('verified_type') == 'phone' ? session('verified_value') : old('phone') }}"
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="address"
                                                   class="form-label required">{{ __('register.address') }}</label>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" id="aydinlatma"
                                                   name="is_membership_conditions" required>
                                            <label class="form-check-label " style="cursor: pointer;font-size: 14px"
                                                   for="aydinlatma">
                                                Tarafıma avantajlı tekliflerin sunulabilmesi amacıyla kişisel
                                                verilerimin işlenmesine ve paylaşılmasına
                                                <span style="text-decoration: underline" data-bs-toggle="modal"
                                                      data-bs-target="#aydinlatmaModal">
                                                    açık rıza
                                                </span>
                                                veriyorum.
                                            </label>
                                        ...
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" id="iletikabul"
                                                   name="is_electronic_message">
                                            <label class="form-check-label" style="cursor: pointer;font-size: 14px"
                                                   for="iletikabul">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" required type="checkbox"
                                                   id="aydinlatma2" name="is_illumination_text">
                                            <label class="form-check-label" style="cursor: pointer;font-size: 14px"
                                                   for="aydinlatma2">
                                                Kişisel verilerimin işlenmesine yönelik <span
                                                    style="text-decoration: underline" data-bs-toggle="modal"
                                                    data-bs-target="#aydinlatmaModal">aydınlatma metnini </span>
                                                okudum ve anladım.
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal fade" id="aydinlatmaModal" tabindex="-1"
                                         aria-labelledby="aydinlatmaModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                            <div class="modal-content">
                                                <div class="modal-body">

                                                    {{-- Tab Başlıkları --}}
                                                    <ul class="nav nav-tabs mt-4 mb-5" id="aydinlatmaTab"
                                                        role="tablist">
                                                        <li class="nav-item" role="presentation">
                                                            <button class="nav-link active" style="color: #259A38"
                                                                    id="tab1-tab" data-bs-toggle="tab"
                                                                    data-bs-target="#tab1"
                                                                    type="button"
                                                                    role="tab">{{ __('auth.tab1_baslik') }}</button>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <button class="nav-link" id="tab2-tab"
                                                                    style="color: #259A38" data-bs-toggle="tab"
                                                                    data-bs-target="#tab2"
                                                                    type="button"
                                                                    role="tab">{{ __('auth.tab2_baslik') }}</button>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <button class="nav-link" id="tab3-tab"
                                                                    ...
                                                                    data-bs-target="#tab3"
                                                                    type="button"
                                                                    role="tab">{{ __('auth.tab3_baslik') }}</button>
                                                        </li>
                                                    </ul>
                                    ...
                                    <div class="g-recaptcha mb-2 ot-2 mx-auto text-center"
                                    ...
                                    <div class="col-12">
                                        <input type="submit" class="form-btn mt-2" name="register"
                                               value="{{ __('register.register') }}"/>
                                    </div>
                                </div>
                            </form>
                        </div>
